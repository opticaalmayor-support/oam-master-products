...
export class Sidebar {
  ...
  getDropdownId(label: string): string {
    ...
    // Reemplaza cualquier caracter no alfanumerico por guion para evitar ids invalidos.
  ...
  menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: 'Variants', path: '/variants', icon: '' },
      ],
    },
    {
      label: 'Offers & Winners',
    ...
    },
    {
      ...
      children: [
        { label: 'Pricing Rules', path: '/pricing/rules', icon: '' },
        { label: 'Pricing Simulator', path: '/pricing/simulator', icon: '' },
      ],
    },
    {
      label: 'Suppliers',
    ...
    },
    {
      ...
      children: [
        { label: 'Sync Dashboard', path: '/odoo-sync', icon: '' },
        { label: 'Sync Logs', path: '/odoo-sync/logs', icon: '' },
      ],
    },
    {
      label: 'Settings',
    ...
    {
      label: 'Users',
      icon: '<path d="M10 12a4 4 0 100-8 4 4 0 000 8z"></path><path fill-rule="evenodd" d="M2 18a8 8 0 1116 0H2z" clip-rule="evenodd"></path>',
      path: '/users',
    },
  ];
}
